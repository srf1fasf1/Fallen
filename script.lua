...
-- LIBRARY IGNORE (Do not loadstring god forbid)
    ...
    -- Library init
        ...
        local themes = {
            preset = {
                accent = rgb(30, 108, 253), -- old color: Color3.fromRGB(132, 135, 250)-- (30, 108, 253)
        ...
        local fonts = {}; do
            ...
            local Minecraft = Register_Font("Minecraft", 100, "Normal", {
                Id = "Minecraft.ttf",
            ...
            fonts = {
                ...
                esp = Font.new(Minecraft, Enum.FontWeight.Regular, Enum.FontStyle.Normal)
            }
        end
    --
...
-- docs
    ...
    do -- Visuals
        local section = ui.tabs.visuals:Section({Name = "Self", Side = "Left"}) do
            ...
            section:Toggle({Name = "Viewmodel Position", Info = "gxentry is sigma", Default = false, Flag = "Viewmodel Position", Callback = function(State)
...
library:change_fontsize(9) -- erm idk why i added this. anyways sizes for pixel fonts are: proggy (12), minecraftia (12), proggytiny (9), tahoma windows xp (12)
-- notifications:create_notification({name = "Loaded the cheat!"})
